    ...
    <div className="flex flex-col h-screen bg-primary">
      <div className="border-b border-border-subtle px-6 py-4 flex gap-4 items-center bg-elevated">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-lg font-semibold">Flujos Multi-Agente</h1>
        </div>
      ...
      <div className="px-6 py-3 bg-surface/40 border-b border-border-subtle text-sm text-text-secondary">
        Esta sección permite construir flujos multi-agente y ejecutarlos con un prompt para obtener una salida final. Pasos: 1) selecciona agentes, 2) guarda workflow, 3) ejecuta.
      </div>
        ...
        <div className="flex-1 flex overflow-hidden">
          {selectedWorkflow ? (
            ...
            <div className="flex-1 flex items-center justify-center text-text-secondary">
              <div className="text-center p-6 bg-elevated border border-border-subtle rounded-2xl">
                Selecciona o crea un flujo en "Construir flujo" para poder ejecutarlo.
              </div>
            </div>
          )}
        </div>
